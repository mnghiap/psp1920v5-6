...
uint16_t js_getHorizontal(){
	...
	ADCSRA |= 0b01000000; // Set ADSC bit to start conversion
...
Direction js_getDirection(){
	 ...
	 * 0.0V - 2.0V represents the low (x: left, y: down) position
	 * 2.0V - 3.0V represents the neutral position
	 * 3.0V - 5.0V represents the high (x: right, y: up) position
	 *
